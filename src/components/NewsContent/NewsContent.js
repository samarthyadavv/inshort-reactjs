    ...
    <div className="app-content">
      <div className="download-text">
        <p>
          ...
          <span style={{ fontWeight: "bold" }}>inshorts</span> app on your smartphone.
        </p>
        <a
      ...
      {newsArray
        .filter((item) => item.title && item.description && item.url && item.urlToImage) // Only show items with title, description, and url
        ...
        .map((props) => {
          ...
          return (
            <div className="newsCard" key={url}>
              <img
                className="newsImage"
                src={
                  urlToImage
